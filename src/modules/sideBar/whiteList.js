...
function WhiteList() {
  ...
  return (
    <div className="pl-4 pr-4 w-full bg-Slate-200 min-h-screen tablet:grid tablet:grid-cols-1 tablet:px-10 mobile:px-4 mobile:grid mobile:grid-cols-1 pb-16 mobile:pl-0 mobile:pr-0 mobile:pb-0 tablet:pl-0 tablet:pr-0 tablet:pb-0 mobile:mt-0 tablet:mt-0">
        ...
        <div className="overflow-x-auto relative bg-white px-5 mt-8 rounded-xl mobile:hidden tablet:hidden">
          <table className="w-full mt-9 ">
            <tr className="w-full gap-x-0 mt-8 px-2 justify-items-start font-PoppinsSemiBold text-ft1 text-darkGrey-50 border-solid">
              ...
              <th className=" text-left text-tHead text-ft1">Mobile Number</th>
